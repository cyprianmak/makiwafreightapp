// app.js - FRONTEND ONLY (Browser JavaScript)
(function() {
  'use strict';
  ...
  const loadUserAccess = async () => {
    ...
    try {
      const userAccess = await apiRequest(`/admin/users/${userId}/access`);
  ...
  const saveUserAccess = async () => {
    ...
    try {
      await apiRequest(`/admin/users/${currentSelectedUser}/access`, {
        method: 'PUT',
